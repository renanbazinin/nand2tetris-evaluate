...
import { BLACK, WHITE } from "./screen.js";
...
export class OutputLib {
    ...
    clearChar() {
        this.setColor(WHITE);
        this.os.screen.drawRect(this.col * 8, this.row * 11, (this.col + 1) * 8, (this.row + 1) * 11);
        this.restoreColor();
    }
    moveCursor(i, j) {
    ...
    drawCursor() {
        this.clearChar();
        this.setColor(BLACK);
        this.os.screen.drawRect(this.col * 8 + 2, this.row * 11 + 2, (this.col + 1) * 8 - 2, (this.row + 1) * 11 - 2);
        this.restoreColor();
    }
    printChar(code) {
