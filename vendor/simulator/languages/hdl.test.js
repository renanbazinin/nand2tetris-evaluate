import { grammar, hdlSemantics, } from "./hdl.js";
...
describe("HDL w/ Ohm", () => {
    describe("parts", () => {
        it("parses part wires", () => {
            ...
            expect(hdlSemantics(wire).Wire).toEqual({
                lhs: {
                    pin: "a",
                    start: 2,
                    end: 4,
        ...
        it("parses parts", () => {
            ...
            expect(hdlSemantics(wide).Part).toEqual({
                name: "Nand",
        ...
        it("parses complex parts", () => {
            const not8 = grammar.match(`Not(in[0..1] = true,
        in[3..5] = six,
        in[7] = true,
        out[3..7] = out1,
        address=address[0..13],
        out[2..3]=address[5..6]);`, "Part");
            expect(not8).toHaveSucceeded();
            expect(hdlSemantics(not8).Part).toEqual({
                name: "Not",
    ...
    describe("entire chips", () => {
        it("parses basic chip", () => {
            ...
            expect(hdlSemantics(match).Chip).toEqual({
...
//# sourceMappingURL=hdl.test.js.map