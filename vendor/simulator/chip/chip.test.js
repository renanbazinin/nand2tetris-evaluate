...
import { Bus, Chip, ConstantBus, HIGH, InSubBus, LOW, OutSubBus, parseToPin, printChip, TRUE_BUS, } from "./chip.js";
...
describe("Chip", () => {
    ...
    describe("SubBus", () => {
        ...
        it("widens output busses if necessary", () => {
            const mux4way16 = new Chip(["in[16]", "b[16]", "c[16]", "d[16]", "sel[2]"], ["out[16]"]);
        ...
        it("assigns input inside wide busses", () => {
            class Foo extends Chip {
                ...
                constructor() {
                    ...
                    const out1Bus = new OutSubBus(assertExists(this.pins.get("out1")), 3, 5);
